...
// keyListener is used here so that I can listen to key presses (typing)
public class MorseCodeTranslatorGUI  extends JFrame implements KeyListener{
    ...
    public MorseCodeTranslatorGUI(){
        ...
        // prevent GUI from being able to the resized
        setResizable(false);

        // setting the layout to be null allows us to manually position and set the size of the components in the GUI
        setLayout(null);

        // exit program when closing the GUI
    ...
    private void addGuiComponents(){
        ...
        // change the font size for the text label and the font weight
        ...
        // set the x y position and the height and height dimensions
        ...
        textInputLabel.setBounds(20,100,200,300);
       ...
       textInputScroll.setBounds(20,132,484,236);
        ...
        // adds scrolling ability to morse code 
        ...
        playSoundButton.addActionListener(new ActionListener() {
            ...
            public  void actionPerformed(ActionEvent e){
                // display the play button (prevents the sound from getting interrupted)
                ...
                Thread playMorseCodeThread = new Thread(new Runnable() {
                    ...
                    public void run(){
                        ...
                        try{
                            String[] morseCodeMessge = morseCodeArea.getText().split("");
                            morseCodeController.playSound(morseCodeMessge);
    ...
    // ignore key shift press
        if(e.getKeyCode() != KeyEvent.VK_SHIFT){
    //   retreive textt input
